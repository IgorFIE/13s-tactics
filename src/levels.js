...
export const Levels = [
    ...
    new Level(
        ...
        [
            [CharacterType.MELEE, new Point(5, 7), DirectionType.UP],
        ],
        [
    ...
    new Level(
        ...
        [
            [CharacterType.MELEE, new Point(2, 4), DirectionType.UP],
            [CharacterType.MELEE, new Point(5, 4), DirectionType.UP],
        ],
        [
    ...
    new Level(
        ...
        [
            ...
            [CharacterType.MELEE, new Point(4, 5), DirectionType.DOWN],
        ],
        [
            [CharacterType.SHIELD, new Point(8, 3), DirectionType.DOWN],
            [CharacterType.RANGE, new Point(7, 0), DirectionType.LEFT],
            [CharacterType.MELEE, new Point(4, 1), DirectionType.UP],
    ...
    new Level(
        ...
        [
            [CharacterType.RANGE, new Point(4, 2), DirectionType.DOWN],
        ]
    ),
    new Level(
        [
        ...
        [
            [CharacterType.RANGE, new Point(5, 2), DirectionType.RIGHT],
    ...
    new Level(
        ...
        [
            [CharacterType.RANGE, new Point(1, 1), DirectionType.DOWN],
            [CharacterType.SHIELD, new Point(4, 3), DirectionType.DOWN],
            [CharacterType.RANGE, new Point(7, 1), DirectionType.DOWN],
        ]
    ),
    new Level(
        [
            ...
            new Point(3, 6), new Point(3, 7), new Point(4, 7),

            new Point(0, 7), new Point(1, 8),
        ],
        [
            [CharacterType.RANGE, new Point(1, 4), DirectionType.RIGHT],
            [CharacterType.MELEE, new Point(2, 5), DirectionType.RIGHT],
            [CharacterType.MELEE, new Point(3, 7), DirectionType.UP],
        ],
        [
            [CharacterType.MELEE, new Point(8, 0), DirectionType.DOWN],

            [CharacterType.SHIELD, new Point(6, 0), DirectionType.LEFT],
            [CharacterType.SHIELD, new Point(6, 1), DirectionType.LEFT],
            [CharacterType.SHIELD, new Point(7, 2), DirectionType.DOWN],
            [CharacterType.SHIELD, new Point(8, 3), DirectionType.LEFT],
    ...
    new Level(
        [
            new Point(4, 0),
            new Point(1, 1), new Point(2, 1), new Point(6, 1), new Point(7, 1), new Point(8, 1),
            ...
            new Point(0, 5), new Point(1, 5), new Point(6, 5), new Point(8, 5),
            new Point(3, 6), new Point(4, 6), new Point(6, 6),
            new Point(1, 7), new Point(2, 7), new Point(4, 7), new Point(7, 7), new Point(8, 7),
            new Point(4, 8),
        ],
        [
            [CharacterType.SHIELD, new Point(8, 8), DirectionType.LEFT],
            [CharacterType.RANGE, new Point(8, 5), DirectionType.LEFT],
            [CharacterType.MELEE, new Point(7, 5), DirectionType.UP],
        ],
        [
            [CharacterType.RANGE, new Point(8, 0), DirectionType.LEFT],
            [CharacterType.RANGE, new Point(4, 1), DirectionType.LEFT],
            [CharacterType.SHIELD, new Point(1, 2), DirectionType.LEFT],
            [CharacterType.RANGE, new Point(6, 3), DirectionType.LEFT],
            [CharacterType.SHIELD, new Point(2, 4), DirectionType.DOWN],
            [CharacterType.SHIELD, new Point(5, 5), DirectionType.LEFT],
            [CharacterType.RANGE, new Point(0, 6), DirectionType.RIGHT],
            [CharacterType.SHIELD, new Point(3, 7), DirectionType.DOWN],
            [CharacterType.SHIELD, new Point(7, 8), DirectionType.RIGHT],
        ]
    ),
];